...
public class XATItemsRegistry
{
	...
	//normal items
	public static final RegistryObject<Item> GLOWING_INGOT = ITEMS_REGISTRY.register("glowing_ingot", () -> new Item(new Item.Properties().tab(Xat.XAT_ITEMS_TAB)));
	public static final RegistryObject<Item> GLOWING_DUST = ITEMS_REGISTRY.register("glowing_dust", () -> new Item(new Item.Properties().tab(Xat.XAT_ITEMS_TAB)));
	public static final RegistryObject<Item> GLOWING_GEM = ITEMS_REGISTRY.register("glowing_gem", () -> new Item(new Item.Properties().tab(Xat.XAT_ITEMS_TAB)));
